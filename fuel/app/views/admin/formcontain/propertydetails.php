    ...
    <div class="row addrow-row">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                ...
                <select class="form-control" name="project_type_<?php echo $count; ?>" id="project_type_<?php echo $count; ?>">
                    <option value="Resisdent" <?php
                    if ($value['type'] == 'Resisdent') {
                        echo 'checked';
                    }
                    ?>>Resisdent</option>
        ...
        <div class="col-lg-1">
            <div class="form-group">
                ...
                if ($value['visibility'] == 'Yes') {
                    echo '<input type="checkbox" name="property_visibility_' . $count . '" checked value="Yes">';
                } else {
                    echo '<input type="checkbox" name="property_visibility_' . $count . '" value="No">';
                }
                ?>               
            </div>
        </div>
...
for ($i = 5; $i > $field; $i--) {
    ...
    <div class="row addrow-row">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <label>Type:</label>
                <!-- <input class="form-control" name="project_type_<?php echo $count; ?>" placeholder="Type"> -->
                <select class="form-control" name="project_type_<?php echo $count; ?>" id="project_type_<?php echo $count; ?>">
                    <option value="Resisdent">Resisdent</option>
                    <option value="Commercial">Commercial</option>
                </select>
                <input class="form-control id" type="hidden" name="project_details_id_<?php echo $count; ?>" placeholder="Type" value="novalue">
            </div>
        </div>
        <div class="col-lg-2">
            <div class="form-group">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <label>Size:</label>
                <input class="form-control calculate-size" name="size_<?php echo $count; ?>" placeholder="">                     
            </div>
        </div>
        <div class="col-lg-2">
            <div class="form-group">
                <label>Price/Per:</label>
                <input class="form-control calculate-price" name="price_per_<?php echo $count; ?>" placeholder="">                     
            </div>
        </div>
        <div class="col-lg-2">
            <div class="form-group">
                <label>Total:</label>
                <input class="form-control calculate-total" name="total_<?php echo $count; ?>" placeholder="">                     
            </div>
        </div>
        <div class="col-lg-1">
            <div class="form-group">
                <label>Visibility:</label>
                <input type="checkbox" name="property_visibility_<?php echo $count; ?>" value="Yes">
            </div>
        </div>
    </div>
    <?php
