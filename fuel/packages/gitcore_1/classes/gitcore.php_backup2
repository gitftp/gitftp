...
class gitcore {
    ...
    public function __construct() {
        ...
        // $this->output("\r\n<bgGreen>---------------------------------------------------");
        // $this->output("<bgGreen>|              hahaah v{$this->phployVersion}              |");
        // $this->output("<bgGreen>---------------------------------------------------<reset>\r\n");
        $this->output("Starting FTP module.\r\n");
...
//        echo $message . '<br>';
        array_push($this->log, 'OUTPUT: ' . $message);
    }
    ...
    public function debug($message) {
        if ($this->debug)
            $this->output("$message");
        array_push($this->log, 'DEBUG: ' . $message);
    }
    ...
    public function ftpDebug($message) {
        ...
        array_push($this->log, 'FTP: ' . $message);
    }
