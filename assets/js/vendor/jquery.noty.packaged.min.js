    ...
    a.noty.themes.defaultTheme = {name: "defaultTheme", helpers: {borderFix: function () {
                if (this.options.dismissQueue) {
                    ...
                    switch (this.options.layout.name) {
                        ...
                        case"centerRight":
                        case"inline":
                            a(b).css({borderRadius: "0px 0px 0px 0px"}), a(b).first().css({"border-top-left-radius": "4px", "border-top-right-radius": "4px"}), a(b).last().css({"border-bottom-left-radius": "4px", "border-bottom-right-radius": "4px"});
                            break;
                        case"bottom":
                            a(b).css({borderRadius: "0px 0px 0px 0px"}), a(b).first().css({borderRadius: "4px 4px 0px 0px"})
                    }
                }
            ...
            switch (this.$bar.css( {
                    overflow: "hidden",
                        ...
                        this.$message.css({fontSize: "14px", lineHeight: "16px", textAlign: "center", width: "auto", position: "relative", 'font-weight': '500'}), this.$closeButton.css({position: "absolute", top: 4, right: 4, width: 10, height: 10, display: "none", cursor: "pointer"}), this.$buttons.css({padding: 5, textAlign: "right", borderTop: "1px solid #ccc", backgroundColor: "#fff"}), this.$buttons.find("button").css({marginLeft: 5}), this.$buttons.find("button:first").css({marginLeft: 0}), this.$bar.on({mouseenter: function () {
                ...
                case"bottomCenter":
                case"inline":
                    this.$bar.css(), this.$message.css({fontSize: "14px", textAlign: "center"});
                    break;
                case"topLeft":
                case"topRight":
                case"bottomLeft":
                ...
                case"centerLeft":
                case"centerRight":
                    this.$bar.css({borderRadius: "5px"}), this.$message.css({fontSize: "13px", textAlign: "left"});
                    break;
                case"bottom":
                    this.$bar.css({borderRadius: "5px 5px 0px 0px"});
                    break;
                default:
                    this.$bar.css()
            }
            switch (this.options.type) {
                case"alert":
                case"notification":
                    this.$bar.css({backgroundColor: "#eee", borderColor: "#ddd", color: "#444"});
                    break;
                case"warning":
