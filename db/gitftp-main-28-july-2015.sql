...
-- Dumping data for table craftrzt_gitftp.branches: ~5 rows (approximately)
...
-- Dumping data for table craftrzt_gitftp.deploy: ~4 rows (approximately)
DELETE FROM `deploy`;
...
-- Dumping data for table craftrzt_gitftp.ftp: ~4 rows (approximately)
DELETE FROM `ftp`;
...
-- Dumping data for table craftrzt_gitftp.log: ~80 rows (approximately)
DELETE FROM `log`;
...
-- Dumping data for table craftrzt_gitftp.messages: ~4 rows (approximately)
...
-- Dumping data for table craftrzt_gitftp.records: ~86 rows (approximately)
DELETE FROM `records`;
...
INSERT INTO `users` (`id`, `username`, `password`, `group`, `email`, `last_login`, `login_hash`, `profile_fields`, `created_at`, `updated_at`) VALUES
	(228, 'boniface', 'DpH4mFqQaRDL2sE+IqtXL+UEl8xjHz7Plya5GFMdVME=', 2, 'bonifacepereira@gmail.com', '1438012584', '7fd470b77178865d352ffef76b0bda8ab37d3b1a', 'a:6:{s:8:"fullname";s:16:"Boniface pereira";s:3:"hey";s:3:"asd";s:8:"verified";b:0;s:10:"verify_key";s:16:"YaeZQ6GuACmhAozK";s:18:"forgotpassword_key";s:16:"my890OwTSrdXZEk1";s:6:"github";s:8:"craftpip";}', 1427962033, 1437941078);
...
-- Dumping data for table craftrzt_gitftp.users_providers: ~1 rows (approximately)
