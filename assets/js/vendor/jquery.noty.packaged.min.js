    ...
    a.noty.themes.defaultTheme = {name: "defaultTheme", helpers: {borderFix: function () {
            ...
            switch (this.options.type) {
                ...
                case"success":
                    ...
                    break;
                default:
                    this.$bar.css({backgroundColor: "#f8f8f8", borderColor: "#ddd", color: "#555", 'background-image': 'linear-gradient(to bottom, #fff 0%, #f8f8f8 100%)', 'box-shadow': '0 0 6px 0 rgba(0,0,0,.1)'})
            }
