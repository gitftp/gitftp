                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select name="property_budget" id="inputPriceFrom-" class="form-control" style="width: 160px">
                                                ...
                                                <?php
                                                foreach (idconvert::get_budget(2) as $key => $value) {
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="property_name" class="form-control" placeholder="Property Name"/><br>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            if (!empty($properties)) {
                                                foreach ($properties as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>Building floors:</strong> <?php echo $value['building_floors'] ?><br>
                                                            <strong>Property price:</strong> <?php echo $value['property_price'] ?><br>
                                                            <strong>Bedrooms:</strong> <?php echo $value['bedrooms'] ?><br>
                                                            <strong>Bathrooms:</strong> <?php echo $value['bathrooms'] ?><br>
                                                            <strong>Floor no.:</strong> <?php echo $value['floorno'] ?><br>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <strong>Balconies:</strong> <?php echo $value['balconies'] ?><br>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div style="height:5px"></div>
                                                            <a class="btn btn-info btn-xs" href="<?php echo Uri::base(false) ?>editadminbuilder/editpropertyrent/<?php echo $value['property_id']; ?>" target="asda">
                                                                EDIT
                                                            </a>
                                                            <div style="height:5px"></div>
