...
class Controller_Api_Deploy extends Controller {
    ...
    public function action_start($id = null) {
        ...
        try {
            ...
            echo json_encode(array('status' => false, 'reason' => 'There was a problem in connecting your repository.<br>Please verify the Repository URL. <code>$repo['repository']</code>'));
