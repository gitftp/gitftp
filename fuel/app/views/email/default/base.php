        ...
        <tr>
            <td valign="top">
                <table align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #b9e1fb solid;border-right:1px #b9e1fb solid;border-bottom:1px #b9e1fb solid;border-radius:0px 0px 4px 4px">
                                <tbody>
                                <tr>
                                ...
                                <tr style="border-collapse:collapse">
                                    ...
                                    <td align="left" valign="top" width="454" style="font-family:Verdana;font-size:13px;color:#444444;">
                                        <?php echo $content; ?>
                                    </td>
                ...
                <table align="center" border="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding:0;border-collapse:collapse">
                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                <tr style="font-family:Verdana;font-size:11px;color:#a8b9c6;" valign="top">
                                    <td align="left" width="400"></td>
                                    <td align="right" width="128">2015 <span class="il">Gitftp</span></td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
